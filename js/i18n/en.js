...
export default {
  ...
  landing: {
    ...
    scrollHint: "there is more, just below",
    introTitle: "Someone cared enough to plant something here.",
    introBody: "Every flower in this garden was drawn by hand, named, and left with a message for whoever finds it. You can wander the paths and read what others have left, or find a quiet plot of your own and grow something for someone you're thinking of.",
  },
  garden: {
    hint: "Wander the garden. Tap a flower to read what someone left.",
    close: "Close",
    replayPlay: "Play",
    replayPause: "Pause",
